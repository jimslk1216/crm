...
<body class="main">
	...
	<form:form action="${ctp }/user/create" method="post"
		...
		<table class="query_form_table" border="0" cellPadding="3"
			...
			<tr>
				...
				<td class="input_content"><form:input path="name" />
					<div id='divCheck'></div></td>

				<th class="input_title">密码</th>
				<td class="input_content"><form:password path="password" /></td>
			</tr>
			<tr>
				<th class="input_title">角色</th>
				<td class="input_content"><form:select path="role.id"
						items="${roles}" itemValue="id" itemLabel="name"></form:select></td>
				<th class="input_title">状态</th>
				<td class="input_content"><form:radiobuttons path="enabled"
						items="${allStatus }" /></td>
			</tr>
		</table>
	</form:form>
